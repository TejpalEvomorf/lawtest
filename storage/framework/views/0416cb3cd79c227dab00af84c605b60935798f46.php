<?php $__env->startSection('loginSignUpLink', '/register'); ?>
<?php $__env->startSection('loginSignUpLinkText', 'Sign up'); ?>
         ...
         <?php echo csrf_field(); ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-8 number-parent">
                        <span><img src="<?php echo e(asset('theme/img/flag.png')); ?>" width="32px">+91</span><input type="text" class="form-control login-numbers" id="LF_phone" name="phone">
                    </div>
                </div>
                <div class="form-group">
                            ...
                            <form id="form_fp">
							 <?php echo csrf_field(); ?>
                                <div class="form-group" id="form_fp_phoneNo">
                                    ...
                                    <div class="col-sm-8 number-parent">
                                        <span><img src="<?php echo e(asset('theme/img/flag.png')); ?>" width="32px">+91</span><input type="text" class="form-control login-numbers" id="form_fp_phone" name="phone">
                                    </div>
                                </div>
